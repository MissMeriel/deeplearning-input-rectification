...
n_actions = 3
policy_net = DQRNNv2(screen_height, screen_width, n_actions).to(device)
target_net = DQRNNv2(screen_height, screen_width, n_actions).to(device)
