...
def main():
    ...
    newdir = f"RLtrain-DDPGonpolicy-halfres-everystep-multiinput-{timestr}-{randstr}"
    if not os.path.exists(newdir):
        os.mkdir(newdir)
        shutil.copy(f"{__file__}", newdir)
        shutil.copy(f"{os.getcwd()}/DDPGonpolicyenv.py", newdir)
    ...
    env = CarEnv(image_shape=(2, 3, 135, 240), model="DDPGMLPMulti", filepathroot=PATH, beamngpath='C:/Users/Meriel/Documents', beamnginstance="BeamNG.researchINSTANCE3",
