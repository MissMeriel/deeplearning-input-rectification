...
def main():
    ...
    newdir = f"DIDIFIXIT-RLtrain-DDPGhuman-halfres-everystep-singleinput-EVALEXPERT-{timestr}-{randstr}"
    ...
    env = CarEnv(image_shape=(3, 135, 240), model="DDPGMLPSingle", filepathroot=PATH, beamngpath='C:/Users/Meriel/Documents', beamnginstance="BeamNG.researchINSTANCE2",
