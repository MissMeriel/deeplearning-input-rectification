...
def main():
    ...
    env = CarEnv(image_shape=(3, 135, 240), model="DDPG", filepathroot=PATH, beamngpath='C:/Users/Meriel/Documents', beamnginstance="BeamNG.researchINSTANCE3",
    ...
    model = DDPG.load("RLtrain-DDPG-11_8-14_57-XNSKL1/best_model")
