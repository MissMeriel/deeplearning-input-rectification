...
class Simulator():
    ...
    def __init__(self, scenario="industrial", spawnpoint='racetrackstartinggate', swerving=None, swervingstdev=None, road_id="7982"):
        ...
        self.spawnpoint_pos = self.get_spawnpoint()
    ...
    def add_barriers(self, scenario):
        ...
        with open('industrial_racetrack_barrier_locations.txt', 'r') as f:
            ...
            for i, line in enumerate(lines):
                ...
                rot_quat = self.turn_90(rot_quat)
    ...
    def add_qr_cubes(self, scenario):
        self.qr_positions = []
    ...
    def setup_beamng(self, vehicle_model='etk800',
                     model_filename="dave2/test-DAVE2v2-lr1e4-50epoch-batch64-lossMSE-25Ksamples-model.pt",
                     beamng_parent="C:/Users/Meriel/Documents",
        ...
        scenario.add_vehicle(vehicle, pos=self.spawnpoint_pos['pos'], rot=None,
                             rot_quat=self.spawnpoint_pos['rot_quat'])  # , partConfig=parts_config)
        self.add_barriers(scenario)
        self.add_qr_cubes(scenario)
        # setup free camera
        ...
        bng.start_scenario()
        ai_line, bng = self.create_ai_line_from_road_with_interpolation(self.spawnpoint_pos, bng)
