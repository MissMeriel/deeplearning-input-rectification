...
class CarEnv(gym.Env):
    ...
    def get_current_segment_shape(self, vehicle_pos):
        ...
        if theta_deg > 100:
            print(f"Road curving left")
            return 1
        elif theta_deg < 80:
            print(f"Road curving right")
            return 2
        else:
            print(f"Road is straight")
            return 0
